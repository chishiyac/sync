...
const hintRootRecipe = tv({
  base: 'relative inline-flex w-fit'
})

const hintPositionerRecipe = tv({
  base: 'outline-none'
})

const hintContentRecipe = tv({
  base: cn(
    'z-50 w-fit min-w-max',
    'px-2 py-1',
    'bg-primary',
...
export { hintContentRecipe, hintPositionerRecipe, hintRootRecipe }
